...
const teamMembers = [
  {
    id: 1,
    name: "Abhilash Yasoji",
    pic: member1,
    linkedin: "https://www.linkedin.com/in/abhilash-yasoji",
  },
  {
    id: 2,
    name: "Bhuvaneshwar Mushke",
    pic: member2,
    linkedin: "https://www.linkedin.com/in/bhuvaneshwar-mushke",
  },

  {
    id: 3,
    name: "Sathish Kuthala",
    pic: member3,
    linkedin: "https://www.linkedin.com/in/sathishkuthala",
  },

  {
    ...
    name: "Teja Kolupula",
    pic: member4,
    linkedin: "https://www.linkedin.com/in/kolupula-teja-3192612b4",
  }
      ...
      <div className="container  mx-auto px-4 py-12">
              ...
              <div className="flex flex-col md:flex-row items-center gap-12">
                <div className="md:w-1/2 text-center md:text-left">
                  ...
                  <p className="text-gray-800 text-lg mb-4">
                    Farmify was founded with a simple yet powerful mission:
        ...
        <section className="text-center mb-8">
          ...
          <p className="text-xl text-gray-500 max-w-3xl mx-auto mb-8">
            ...
            consumer seeking fresh, local produce, Farmify is for you.
          </p>
